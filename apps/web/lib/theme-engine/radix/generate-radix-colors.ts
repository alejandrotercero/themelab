// Vendored verbatim from Radix UI's website — components/generateRadixColors.tsx
// (https://github.com/radix-ui/website), MIT © WorkOS / Radix UI contributors.
// This is the exact algorithm behind https://www.radix-ui.com/colors/custom.
// See apps/web/NOTICE.
/* eslint-disable @typescript-eslint/ban-ts-comment, prefer-const, @typescript-eslint/no-unused-vars */
// @ts-nocheck
...
const lightColors = Object.fromEntries(
  scaleNames.map((scaleName) => [
    scaleName,
    // oxlint-disable-next-line import/namespace -- vendored verbatim from Radix UI, not modified per apps/web/CLAUDE.md
...
export const generateRadixColors = ({
  ...
  // oxlint-disable-next-line no-use-before-define -- vendored verbatim from Radix UI, not modified per apps/web/CLAUDE.md
  ...
  return {
    ...
    // oxlint-disable-next-line object-shorthand -- vendored verbatim from Radix UI, not modified per apps/web/CLAUDE.md
...
function getStep9Colors(
  ...
  // oxlint-disable-next-line prefer-destructuring -- vendored verbatim from Radix UI, not modified per apps/web/CLAUDE.md
...
function getButtonHoverColor(source: Color, scales: ArrayOf12<Color>[]) {
  ...
  // oxlint-disable-next-line unicorn/prefer-number-properties -- vendored verbatim from Radix UI, not modified per apps/web/CLAUDE.md
  ...
  // oxlint-disable-next-line unicorn/no-array-for-each -- vendored verbatim from Radix UI, not modified per apps/web/CLAUDE.md
...
function getScaleFromColor(
  ...
  // oxlint-disable-next-line prefer-destructuring, unicorn/prefer-spread -- vendored verbatim from Radix UI, not modified per apps/web/CLAUDE.md
  const baseColor = scale
    .slice()
    // oxlint-disable-next-line no-shadow, unicorn/no-array-sort -- vendored verbatim from Radix UI, not modified per apps/web/CLAUDE.md
  ...
  if (ratioL > 1) {
    ...
    // oxlint-disable-next-line no-plusplus -- vendored verbatim from Radix UI, not modified per apps/web/CLAUDE.md
...
// oxlint-disable-next-line complexity -- vendored verbatim from Radix UI, not modified per apps/web/CLAUDE.md
function getAlphaColor(
  ...
  if (
    ...
    // oxlint-disable-next-line unicorn/new-for-builtins, unicorn/throw-new-error -- vendored verbatim from Radix UI, not modified per apps/web/CLAUDE.md
  ...
  // Convert back to 0-1 values
  // oxlint-disable-next-line operator-assignment -- vendored verbatim from Radix UI, not modified per apps/web/CLAUDE.md
  R = R / rgbPrecision
  // oxlint-disable-next-line operator-assignment -- vendored verbatim from Radix UI, not modified per apps/web/CLAUDE.md
  G = G / rgbPrecision
  // oxlint-disable-next-line operator-assignment -- vendored verbatim from Radix UI, not modified per apps/web/CLAUDE.md
...
export function transposeProgressionStart(
  ...
  // oxlint-disable-next-line no-shadow -- vendored verbatim from Radix UI, not modified per apps/web/CLAUDE.md
...
function toOklchString(color: Color) {
  ...
  return (
    color
      .to("oklch")
      .toString({ precision: 4 })
      // oxlint-disable-next-line prefer-named-capture-group -- vendored verbatim from Radix UI, not modified per apps/web/CLAUDE.md
      .replace(/(\S+)(.+)/, `oklch(${L}%$2`)
  )
}
