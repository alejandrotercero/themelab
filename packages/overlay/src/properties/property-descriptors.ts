...
export const LAYOUT_DESCRIPTORS: PropertyDescriptor[] = [
  {
    ...
    standalone: true,
    classPattern:
      "^(block|flex|grid|inline-flex|inline-block|inline|hidden|contents)$",
    enumValues: [
  ...
  },
  {
    ...
    enumValues: [
      ...
      {
        value: "row-reverse",
        tailwindValue: "row-reverse",
        label: "Row Reverse",
        icon: "←",
      },
      {
        value: "column-reverse",
        tailwindValue: "col-reverse",
...
export const TYPOGRAPHY_DESCRIPTORS: PropertyDescriptor[] = [
  {
    ...
    tailwindPrefix: "text",
    tailwindScale: "fontSize",
    defaultValue: "16px",
    min: 0,
    classPattern: "^text-(xs|sm|base|lg|xl|\\d+xl|\\[.+\\])$",
  },
  {
    key: "fontWeight",
    label: "Weight",
  ...
  },
  {
    ...
    cssProperty: "color",
    tailwindPrefix: "text",
    tailwindScale: "colors",
    defaultValue: "#000000",
    classPattern:
      "^text-(\\w+-\\d+|black|white|transparent|current|inherit|\\[.+\\])$",
  },
];
...
export const BORDER_DESCRIPTORS: PropertyDescriptor[] = [
  ...
  },
  {
    ...
    tailwindScale: "borderWidth",
    defaultValue: "0",
    min: 0,
    classPattern: "^border(-(0|2|4|8))?$|^border-\\[.+\\]$",
  },
  {
    key: "borderColor",
    label: "Color",
    ...
    defaultValue: "transparent",
    classPattern:
      "^border-(\\w+-\\d+|black|white|transparent|current|inherit|\\[.+\\])$",
  },
  {
    key: "borderStyle",
    label: "Style",
