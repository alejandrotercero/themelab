...
export const Header = (props: HeaderProps) => {
  ...
  return (
    <section className="px-[5%] py-10 md:py-16 lg:py-20 dark:bg-neutral-950 bg-accent">
        ...
        <div className="flex flex-col">
          <div className="mb-8 md:mb-18 lg:mb-10">
            <div className="w-full max-w-lg">
              ...
              <p className="md:text-md text-muted-foreground">{description}</p>
          ...
          <div>
            <img src={image.src} className="size-full object-cover rounded-2xl border-foreground/30 border shadow-md shadow-black dark:shadow-primary" alt={image.alt} />
          </div>
        </div>
      </div>
    </section>
...
"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique.",
  commands: [
    ...
    { label: "npm", code: "npm install -g themelab" },
    { label: "pnpm", code: "pnpm add -g themelab" },
  ],
  image: {
