// Tailwind v4 default color palette (oklch values, lifted from the public
// Tailwind palette — data only). Rendered to swatches via culori; the token
// name (e.g. "red-500") is what gets written as a class.
//
// Order here is the display order in the palette picker.
