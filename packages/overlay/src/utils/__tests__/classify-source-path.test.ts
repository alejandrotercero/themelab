...
describe("classifySourcePath", () => {
  ...
  it("classifies a webpack-internal-wrapped app file as app", () => {
    expect(classifySourcePath("webpack-internal:///./src/components/Button.tsx").origin).toBe(
      "app",
    );
  });

  it("classifies a node_modules dependency as package", () => {
    const result = classifySourcePath("node_modules/@radix-ui/react-dialog/dist/index.js");
  ...
  it("classifies a Vite optimized-dep (flattened scoped pkg) as package, not app", () => {
    const result = classifySourcePath("/project/node_modules/.vite/deps/@radix-ui_react-dialog.js");
    expect(result.origin).toBe("package");
    expect(result.packageName).toBe("@radix-ui/react-dialog");
  });
  ...
  it("classifies a monorepo workspace file (leading ../) as app", () => {
    expect(classifySourcePath("../../packages/ui/src/Button.tsx").origin).toBe("app");
  });
...
describe("resolvePackageName", () => {
  it("reads a scoped node_modules package", () => {
    expect(resolvePackageName("node_modules/@mui/material/Button.js")).toBe("@mui/material");
  });
  ...
  it("reads a Vite optimized unscoped dep", () => {
    expect(resolvePackageName("node_modules/.vite/deps/react-dom.js")).toBe("react-dom");
  });
